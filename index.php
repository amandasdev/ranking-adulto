  ...
  <div id="page" class="site">
    ...
    <style type="text/css">
      ...
      .blue-box h3 {
        ...
        margin-bottom: 10px;
        margin-top: 30px;
        background: url(assets/image/pros.png) no-repeat 0 2px;
        padding: 0 0 0 40px;
      }

      .blue-box.arrowicon p {
        background: url(assets/image/green-check.png) no-repeat 0 8px;
        padding-left: 25px;
      }

      .red-box p {
        background: url(assets/image/red-cross.png) no-repeat 0 0px;
        padding-left: 35px;
      }

      ul.check-list li {
        background: url(assets/image/check-green.png) no-repeat 0 5px;
        list-style: none;
        padding: 0 0 0 30px;
        margin-bottom: 15px;
        font-size: 17px;
      ...
      .review-box {
        border-radius: 30px;
        background: #fff url(assets/image/golden-bg.png) no-repeat 0 -2px;
        padding: 8% 0px 10px;
      ...
      .review-box.silverproduct {
        background: #fff url(assets/image/silver-bg.png) no-repeat 0 -2px;
        margin-bottom: 9em;
      }
      ...
      .left .pros-cons li {
        background: url(assets/image/circle-check-green.png) no-repeat 0 4px;
      }

      ul.conslist li {
        background: url(assets/image/circle-cancel-pink.png) no-repeat 0 4px !important;
      }
      ...
      ul.evaluation-list li {
        background: url(assets/image/green-check\ 2.png) no-repeat 0 3px;
        padding-left: 35px;
        margin-bottom: 10px;
      ...
      .review-box.silverproduct img.thebadge {
        display: block;
        background: #ffffff00;
        left: 39%;
        top: -5%;
      ...
      .review-box .circle-summary h4 a {
        background: #3071b9;
        width: 240px;
        height: 52px;
        border-radius: 37px;
      ...
      .review-box .circle-summary h4 a:hover {
      ...
      .bluearea {
        ...
        height: 30px;
        position: absolute;
        background: rgba(55, 148, 214, 1);
        background: -webkit-linear-gradient(#3794D6, #294797);
        background: -moz-linear-gradient(#3794D6, #294797);
        background: linear-gradient(#3794D6, #294797);
        background: -ms-linear-gradient(#3794D6, #294797);
        background: -o-linear-gradient(#3794D6, #294797);
      }

      .bar.rating-9-7 .bluearea {
        width: 97%;
      }

      .bar.rating-9-6 .bluearea {
        width: 96%;
      }

      .bar.rating-9-5 .bluearea {
        width: 95%;
      }

      .bar.rating-9-4 .bluearea {
        width: 94%;
      }

      .bar.rating-9-3 .bluearea {
        width: 93%;
      }

      .bar.rating-9-2 .bluearea {
        width: 92%;
      }

      .bar.rating-9-1 .bluearea {
        width: 91%;
      }

      .bar.rating-9 .bluearea {
        width: 90%;
      }

      .bar.rating-8-9 .bluearea {
        width: 89%;
      }

      .bar.rating-8-7 .bluearea {
        width: 87%;
      }

      .bar.rating-8-8 .bluearea {
        width: 88%;
      }

      .bar.rating-8-1 .bluearea {
        width: 81%;
      }

      .bar.rating-8 .bluearea {
        width: 80%;
      }

      .bar.rating-7-8 .bluearea {
        width: 78%;
      }

      .bar.rating-7-6 .bluearea {
        width: 76%;
      }

      .bar.rating-7-5 .bluearea {
        width: 75%;
      }

      .bar.rating-8-3 .bluearea {
        width: 83%;
      }

      .bar.rating-8-4 .bluearea {
        width: 84%;
      }

      .bar.rating-8-2 .bluearea {
        width: 82%;
      }

      .bar.rating-8-5 .bluearea {
        width: 85%;
      }
      ...
      .product-image-mainbox {
        text-align: center;
        margin: 0 auto 3em;
        width: 75%;
      }

      .product-image-mainbox h1 {
        font-size: 44px;
        font-weight: 700;
      ...
      .top-most-section {
        background-image: url(assets/image/top-most-bg.jpg);
        min-height: 205px;
        width: 100%;
      }
      ...
      .top-most-section ul li:first-child {
        padding-left: 0;
      }

      .top-most-section ul li img {
        padding-right: 15px;
      }

      .top-most-section ul li:after {
        content: '|';
        position: relative;
        left: 13px;
        font-weight: 100;
      ...
      .our-choice-right ul li {
        background: url(assets/image/green-bullet.png) no-repeat 0 6px;
        padding-left: 20px;
        list-style: none;
        font-size: 15px;
      }
      ...
      @media screen and (max-width: 767px) {
        ...
        .review-box form input[type='text'],
        ...
        .top-rated-prod .circle-summary {
          padding-top: 12px;
        }

        .top-rated-prod .circle-summary,
        .top-rated-prod .grade {
          width: 50%;
          height: 190px;
          border-bottom: 1px solid #ddd;
        }
        ...
        .top-rated-prod .circle-summary p {
          top: 58px !important;
        }
        ...
        .top-rated-prod .circle-summary h5 {
          top: 65px !important;
        }
    ...
    <div class="wrap">
                ...
                <div class="main-section">
                  ...
                  <div id="box-wrap">
                    <div class="review-box">
                      <p><a href="https://www.virectinstore.com/pages/limited-time-offer"><img class="thebadge" src="assets/image/top-seal-1-3.png" alt="top-seal"></a></p>
                      <h4><a href="best-male-sexual-enhancement-supplements-on-the-market-test.html#">1. Virectin</a>
                      </h4>
                      <p class="byline"><a href="https://www.virectinstore.com/pages/limited-time-offer">by Gentopia
                          Laboratories</a></p>
                      <div class="product-image-mainbox">
                        <h1>A+ Rating</h1>
                        <div class="product-image-box"><a href="https://www.virectinstore.com/pages/limited-time-offer"><img src="assets/image/virectin.jpg" alt="Virectin"></a></div>
                        <div class="circle-summary"><img class="circle-img" src="assets/image/circle-img-01.png" alt="circle-img">
                          <div class="circle-text">
                            <h4><a href="https://www.virectinstore.com/pages/limited-time-offer">Total Ranking</a>
                            </h4>
                            <h5>9.8/10</h5>
                            <p>1563 votes</p>
                          </div>
                      ...
                      <div class="bottom-line">
                        ...
                        <hr>
                        <p class="learnmoreBtn"><a class="top" href="https://www.virectinstore.com/pages/limited-time-offer">LEARN MORE ABOUT
                            VIRECTIN<img class="larrow" src="https://www.totalhealthreports.com/wp-content/uploads/2021/04/thr-arrow-new.gif" alt="arrow"></a></p>
                      </div>
                    </div>
                    <div class="review-box silverproduct">
                      <p><a href="https://www.totalhealthreports.com/prime-potence-review.html"><img class="thebadge" src="assets/image/top-seal-2-Gray.png" alt="top-seal"></a></p>
                      <h4><a href="https://www.totalhealthreports.com/prime-potence-review.html">2. Prime Potence</a>
                      </h4>
                      <p class="byline">by <a href="https://www.totalhealthreports.com/prime-potence-review.html">
                          Prime Potence</a></p>
                      <div class="product-image-mainbox">
                        <h1>A- Rating</h1>
                        <div class="product-image-box"><a href="https://www.totalhealthreports.com/prime-potence-review.html"><img src="assets/image/prime-potence-review.jpg" alt="bloom"></a></div>
                        <div class="circle-summary"><img class="circle-img" src="assets/image/circle-img-01 (2).png" alt="circle-img">
                          <div class="circle-text">
                            <h4><a href="https://www.totalhealthreports.com/prime-potence-review.html">Total
                                Ranking</a></h4>
                            <h5>8.9/10</h5>
                            <p>591 votes</p>
                          </div>
                      ...
                      <div class="bottom-line">
                        ...
                        <hr>
                        <p class="learnmoreBtn"><a class="top" href="https://www.totalhealthreports.com/prime-potence-review.html">LEARN MORE <img class="larrow" src="assets/image/arrow-01.png" alt="arrow"></a></p>
                      </div>
                    </div>
                    <div class="review-box silverproduct">
                      <p><a href="https://www.totalhealthreports.com/male-exxtra-review.html"><img class="thebadge" src="assets/image/top-seal-4-Gray.png" alt="top-seal"></a></p>
                      <h4><a href="https://www.totalhealthreports.com/male-exxtra-review.html">3. Male Exxtra </a>
                      </h4>
                      <p class="byline">by <a href="https://www.totalhealthreports.com/male-exxtra-review.html">Male
                          Exxtra</a></p>
                      <div class="product-image-mainbox">
                        <h1>B+ Rating</h1>
                        <div class="product-image-box"><a href="https://www.totalhealthreports.com/male-exxtra-review.html"><img src="assets/image/male-ex.jpg" alt="bloom"></a></div>
                        <div class="circle-summary"><img class="circle-img" src="assets/image/circle-img-01.png" alt="circle-img">
                          <div class="circle-text">
                            <h4><a href="https://www.totalhealthreports.com/male-exxtra-review.html">Total Ranking</a>
                            </h4>
                            <h5>8.5/10</h5>
                            <p>415 votes</p>
                          </div>
                      ...
                      <div class="bottom-line">
                        ...
                        <hr>
                        <p class="learnmoreBtn"><a class="top" href="https://www.totalhealthreports.com/male-exxtra-review.html">LEARN MORE <img class="larrow" src="assets/image/arrow-01 (1).png" alt="arrow"></a></p>
                      </div>
                    </div>
                    <div class="review-box silverproduct">
                      <p><a href="https://www.totalhealthreports.com/testolynx.html"><img class="thebadge" src="assets/image/top-seal-4-Gray (1).png" alt="top-seal"></a></p>
                      <h4><a href="https://www.totalhealthreports.com/testolynx.html">4. Testolynx</a></h4>
                      <p class="byline">by <a href="https://www.totalhealthreports.com/testolynx.html"> Testolynx</a>
                      </p>
                      <div class="product-image-mainbox">
                        <h1>B- Rating</h1>
                        <div class="product-image-box"><a href="https://www.totalhealthreports.com/testolynx.html"><img src="assets/image/testolynx-review.jpg" alt="bloom"></a></div>
                        <div class="circle-summary"><img class="circle-img" src="assets/image/circle-img-01 (3).png" alt="circle-img">
                          <div class="circle-text">
                            <h4><a href="https://www.totalhealthreports.com/testolynx.html">Total Ranking</a></h4>
                            <h5>8.1/10</h5>
                            <p>375 votes</p>
                          </div>
                        </div>
                      ...
                      <div class="bottom-line">
                        ...
                        <hr>
                        <p class="learnmoreBtn"><a class="top" href="https://www.totalhealthreports.com/testolynx.html">LEARN MORE <img class="larrow" src="assets/image/arrow-01 (2).png" alt="arrow"></a></p>
                      </div>
                    </div>
                  </div>
                  <div class="review-box silverproduct mb-0">
                    <p><a href="https://www.totalhealthreports.com/biomax-ultra-potent-male-review.html"><img class="thebadge" src="assets/image/top-seal-5-Gray.png" alt="top-seal"></a></p>
                    <h4><a href="https://www.totalhealthreports.com/biomax-ultra-potent-male-review.html">5. BioMax
                        Ultra Potent Male</a></h4>
                    <p class="byline">by <a href="https://www.totalhealthreports.com/biomax-ultra-potent-male-review.html">BioMax</a></p>
                    <div class="product-image-mainbox">
                      <h1>C+ Rating</h1>
                      <div class="product-image-box"><a href="https://www.totalhealthreports.com/biomax-ultra-potent-male-review.html"><img src="https://www.totalhealthreports.com/wp-content/uploads/2021/04/biomax-ultra-potent-male-review.jpg" alt="bloom"></a></div>
                      <div class="circle-summary"><img class="circle-img" src="assets/image/circle-img-01 (4).png" alt="circle-img">
                        <div class="circle-text">
                          <h4><a href="https://www.totalhealthreports.com/biomax-ultra-potent-male-review.html">Total
                              Ranking</a></h4>
                          <h5>7.9/10</h5>
                          <p>305 votes</p>
                        </div>
                    ...
                    <div class="bottom-line">
                      ...
                      <p>Even though <strong>BioMax Ultra Potent Male</strong> is offered at a reasonable price and
                        ...
                        making an order.</p>
                      <hr>
                      <p class="learnmoreBtn"><a class="top" href="https://www.totalhealthreports.com/biomax-ultra-potent-male-review.html">LEARN MORE
      ...
      <div class="black-wrap">
        <a href="best-male-sexual-enhancement-supplements-on-the-market-test.html#stickybookmark" class="getpackage">SEE
          THE TOP RATED PRODUCT NOW <img src="https://www.totalhealthreports.com/wp-content/themes/THR/images/try-btn-arrow-1.gif" alt="GET YOUR PACKAGE"></a>
      </div>
    </div><!-- .wrap -->
